...
class ClassSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Classes
        fields = '__all__'
        read_only_fields = ['id','created_by', 'created_at', 'updated_at', 'jitsi_room_id']
...
class InscriptionSerializer(serializers.ModelSerializer):
    ...
    statut = serializers.CharField(default='en_attente', required=False)
    ...
    def get_fichier_url(self, obj):
        ...
        if obj.type_message in ['audio', 'video'] and obj.fichier.nom_stockage:
            ...
            if nom_stockage.startswith('audio_') or nom_stockage.startswith('screen_') or nom_stockage.startswith('merged_'):
                return f"https://recordings.myklassa.org/{nom_stockage}"
    ...
    def get_reply_to_preview(self, obj):
        ...
        if obj.reply_to.fichier_id and hasattr(obj.reply_to, 'fichier') and obj.reply_to.fichier:
            ...
            if obj.reply_to.type_message in ['audio', 'video'] and fichier_reply.nom_stockage:
                ...
                if nom_stockage.startswith('audio_') or nom_stockage.startswith('screen_') or nom_stockage.startswith('merged_'):
                    fichier_url = f"https://recordings.myklassa.org/{nom_stockage}"
